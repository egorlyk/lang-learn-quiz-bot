...
Every question has to have 2+ possible answers. You have to specify correct answer.
        ...
        functions = [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "questions": {
                        "type": "array",
                        "description": "questions list and answers list",
                        "items": {
                            "question": {
                                "type": "string",
                    ...
                    "topic": {
                        "type": "string",
                        "description": "determined grammar topic of the text",
                    }                    
                }
            }
        }
